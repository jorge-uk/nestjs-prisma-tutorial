...
At the of this tutorial, you will have a products API with three methods: `create`, `findById` and `findMany`. The products API will use `Prisma` to create and connect to a local database.
